 ...
 */
$settings['container_yamls'][] = DRUPAL_ROOT . '/local-dev/development.services.yml';

// Config sync folder
$config_directories = array(
	CONFIG_SYNC_DIRECTORY => DRUPAL_ROOT . '/config_customdev/sync',
	CONFIG_STAGING_DIRECTORY => DRUPAL_ROOT . '/config_customdev/staging/',
);
